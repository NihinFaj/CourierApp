...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_qr_scanner__ = __webpack_require__(112);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = /** @class */ (function () {
    function HomePage(qrScanner, device, loadingCtrl, navCtrl, courierProvider, sessionProvider) {
        ...
        this.courierProvider.callService(this.getAllUserURL)
            ...
            if (result.StatusCode == 1000) {
                ...
                if (_this.Users.length === 0) {
                    _this.courierProvider.presentAlert("There are no available users at the moment.");
                    return false;
                }
            }
            else {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_qr_scanner__ = __webpack_require__(112);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ionic_Storage__ = __webpack_require__(166);
