...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__riderdashboard__ = __webpack_require__(327);
                        ...
                        this.courierProvider.callServicePost(this.getRiderRequestURL, this.data)
                            ...
                            if (result.StatusCode == 1000) {
                                ...
                                if (_this.allRequests.length === 0) {
                                    _this.courierProvider.presentAlert("There are no available request for you at the moment");
                                    return false;
                                }
                            }
                            else {
