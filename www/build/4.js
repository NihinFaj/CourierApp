...
var LinkdevicePage = /** @class */ (function () {
    function LinkdevicePage(courierProvider, sessionProvider, navCtrl, navParams, loadingCtrl) {
        ...
        this.getAllRiderRequest = 'http://gtmobile.gtbank.com/CourierAPI/api/Courier/get-all-rider-requests';
    }
    ...
    LinkdevicePage.prototype.getAllRequests = function () {
        ...
        this.courierProvider.callServicePost(this.getAllRiderRequest, this.data)
            ...
            if (result.StatusCode == 1000) {
                ...
                _this.sessionProvider.setStorage('userName', "Array of all requests gotten from DB").then(function () {
                    _this.navCtrl.setRoot("RiderdashboardPage");
                });
            }
            else {
                _this.loading.dismissAll();
